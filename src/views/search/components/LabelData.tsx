...
export const LabelDataItem: React.FC<any> = ({
  ...
  return (
    <div className={` relative w-[486px] h-[337px] text-[#3F4664] rounded-lg px-[1px] ${bgColor}`}>
      <div className="bg-white w-full h-[335px] rounded-[7px] relative top-[1px]">
        <LazyImage src={tipIcon} className="w-[24px] h-[24px] absolute left-[22px] -top-[11px]" />
